...
const defaultSource = "./uptime-kuma";
...
function extractPushEventsFromClient(rootDir) {
    ...
    const statusPageModelFile = path.join(
        rootDir,
        "server",
        "model",
        "status_page.js",
...
printDiff(
    "Socket events documented but not found in source",
    socketDiff.missingFromSource,
);
printDiff("Push events missing from docs", pushDiff.missingFromDocs);
printDiff(
    "Push events documented but not found in source",
    pushDiff.missingFromSource,
);
